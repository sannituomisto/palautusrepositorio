...
class TestKauppa(unittest.TestCase):
    ...
    def test_kutsutaan_tilisiirto_oikeilla_arvoilla(self):
        self.setUp()
    ...
    def test_kutsutaan_tilisiirto_oikeilla_arvoilla_2(self):
        self.setUp()
    ...
    def test_kutsutaan_tilisiirto_oikeilla_arvoilla_3(self):
        self.setUp()
    ...
    def test_kutsutaan_tilisiirto_oikeilla_arvoilla_4(self):
        self.setUp()
    ...
    def test_aloita_asiointi_nollaa_edelliset(self):
        ...
        self.kauppa.aloita_asiointi()
        self.kauppa.lisaa_koriin(2)
        self.kauppa.tilimaksu("sanni", "24689")

        self.pankki_mock.tilisiirto.assert_called_with("sanni", ANY, "24689", ANY, 7)
